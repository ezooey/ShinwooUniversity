...
<% 	
	...
	String searchAdBook = (String)request.getAttribute("searchAdBook");
%>
		...
		<div id="personalInf">
			<table class="table table-hover">
				...
				<tbody>
					...
					<% if (list.isEmpty()) { %>
					<tr>
						<th colspan="8" style="text-align: center;">존재하는 도서가 없습니다.</th>
					</tr>
					<% } else { %>
			...
			<div class="pagingArea" align='center'>
				<div class="pagingArea page-item" align="center">
					<button class="listBtn" id="startBtn" onclick="location.href='<%=request.getContextPath()%>/searchAdminBook.bo?currentPage=1&searchAdBook=<%= searchAdBook %>'">
						<i class="fas fa-angle-double-left"></i>
					</button>
					<button class="listBtn" id="beforeBtn" onclick="location.href='<%=request.getContextPath()%>/searchAdminBook.bo?currentPage=<%=pi.getCurrentPage() - 1%>&searchAdBook=<%= searchAdBook %>'">
					...
					%>
					<button class="listBtn" id="numBtn" onclick="location.href='<%=request.getContextPath()%>/searchAdminBook.bo?currentPage=<%=p%>&searchAdBook=<%= searchAdBook %>'"><%=p%></button>
					<%
						}
					%>
					<%
					...
					<button class="listBtn" id="afterBtn" onclick="location.href='<%=request.getContextPath()%>/searchAdminBook.bo?currentPage=<%=pi.getCurrentPage() + 1%>&searchAdBook=<%= searchAdBook %>'">
						<i class="fas fa-angle-right"></i>
					</button>
					<button class="listBtn" id="endBtn" onclick="location.href='<%=request.getContextPath()%>/searchAdminBook.bo?currentPage=<%=pi.getMaxPage()%>&searchAdBook=<%= searchAdBook %>'">
