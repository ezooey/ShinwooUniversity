				...
				<div id="slider-div">
					<div class="book-div">
						<a href="https://www.naver.com"><img
							src="sample/image/book1.png" class="bookimage"></a>
					</div>
					<div class="book-div">
						<a href="https://www.naver.com"><img
							src="sample/image/book2.png" class="bookimage"></a>
					</div>
					<div class="book-div">
						<a href="https://www.naver.com"><img
							src="sample/image/book3.png" class="bookimage"></a>
					</div>
					<div class="book-div">
						<a href="https://www.naver.com"><img
							src="sample/image/book4.png" class="bookimage"></a>
					</div>
					<div class="book-div">
						<a href="https://www.naver.com"><img
							src="sample/image/book5.png" class="bookimage"></a>
					</div>
					<div class="book-div">
						<a href="https://www.naver.com"><img
							src="sample/image/book1.png" class="bookimage"></a>
		...
		<section class="wantToWork-area back">
			<div class="container">
				...
				<div class="header-right d-none d-lg-block" style="float: right;">
					<button type="button" class="genric-btn primary circle" id="login">전체보기
						></button>
				</div>
			</div>
<<<<<<< HEAD
