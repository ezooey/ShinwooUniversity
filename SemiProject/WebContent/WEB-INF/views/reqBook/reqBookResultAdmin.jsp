<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="java.util.ArrayList, reqBook.model.vo.ReqBook"%>
<%
...
<body>
	...
	<br>
	<% if(r.getStatus()== 2){%>
	<h2 align="center">도서 신청 거절 사유</h2>
	<div class="tableArea">
		<table>
			<tr>
				<td>
					<textarea name="content" cols="60" rows="5" style="resize: none;" readonly><%= r.getReqBookReason() %></textarea>
				</td>
			</tr>
		</table>
		<% }%>
	...
	<div class="bottomBtn" align="center">
		<button class="genric-btn danger-border small" onclick="window.close()">닫기</button>
	</div>
