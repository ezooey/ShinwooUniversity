            ...
            $.ajax({
                    ...
                    for (var i = 0; i < lengthBook; i++) {
                    	...
                    	if(info !== null && info !== undefined){
	                    	...
	                    	tableAppend += "<tr>";
	                    	tableAppend += "<th width='60'>"
	                    	tableAppend += "<input type='radio' name='selectBook' style='width:20px;height:20px;'>";
	                    	tableAppend += "<input type='hidden' name='searchTitle' value='" + title + "'>";
	                    	tableAppend += "<input type='hidden' name='searchAuthors' value='" + authors + "'>";
	                    	tableAppend += "<input type='hidden' name='searchPub' value='" + publisher + "'>";
	                    	tableAppend += "<input type='hidden' name='searchDate' value='" + redate + "'>";
	                    	tableAppend += "</th>";
